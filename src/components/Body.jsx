...
const Body = () => {
    return (
        <div className='space-y-4 lg:flex'>
            <div className='flex items-center justify-center md:h-72 lg:flex-1 lg:order-2 lg:justify-end'>
           ...
           <img src="./assets/Hero-Model.png" alt="4th" className='absolute h-64 md:h-72 lg:h-[400px]'/>
            ...
            <div className='lg:flex-1 lg:order-1'>
                ...
                <p className='font-lato text-gray-400'>with Hoster, get your website up and running in no less than 5 minutes with the most competitive pricing packagge available online.
                </p>
                <form action='' className='flex flex-col gap-2 my-2 md:flex-row'>
